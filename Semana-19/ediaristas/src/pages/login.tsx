...
const Login: React.FC = () => {
    const { formMethods, errorMessage, onSubmit, externalServiceState } = useLogin();
    return (
        <div>
            <FormProvider {...formMethods}>
                ...
                <Container>
                    ...
                    <LoginContainer as={'form'} onSubmit={formMethods.handleSubmit(onSubmit)}>
                        <LoginForm />
                        ...
                        color={'secondary'}
                        type={'submit'}
                        disabled={externalServiceState?.externalServices?.length === 0}
                        >
                            Entrar
                        </LoginButton>
                    </LoginContainer>
