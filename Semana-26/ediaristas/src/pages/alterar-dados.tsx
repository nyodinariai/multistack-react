...
import { AddressForm, CitiesForm, ContactForm, FinancialForm, UserDataForm, UserFormContainer } from 'ui/components/inputs/UserForm/UserForm';
import PageTitle from 'ui/components/data-display/PageTitle/PageTitle';
import { Box, Button, Paper, Snackbar, Typography } from '@mui/material';
import { FormContainer, UserPicture } from '@styles/pages/pages/alterar-dados.styled';
import { UserType } from 'data/@types/UserInterface';
import { textAlign } from '@mui/system';
// import {Component } from 'styles/pages/pages/alterar-dados.styled'; 
...
export const getStaticProps: GetStaticProps = async () => { 
  return {
    props: { title: 'Alterar Dados', },
  }; 
 }; 
const AlterarDados: React.FC = () => { 
    const {user, userAddress, formMethods, picture, onPictureChange, snackMessage, setSnackMessage, onSubmit} = useAlterarDados();
  return (
              ...
              <UserFormContainer>
                  ...
                  <Paper sx={{ mb: 3, mt: 15, position: 'relative' }}>
                    <UserPicture>
                        ...
                        <input type={'file'} {...formMethods.register('usuario.foto_usuario')} onChange={onPictureChange} accept={'.jpeg, .jpg, .png'}/>
