import { DiariaStatus } from './../../../@types/DiariaInterface';
        ...
        function filtrarDiarias(diarias: DiariaInterface[], filtro: string){
            return diarias.filter((item) => {
                const avaliada = [DiariaStatus.AVALIADO].includes(
                    ...
                    cancelada = [DiariaStatus.CANCELADO, DiariaStatus.SEM_PAGAMENTO].includes(
                        item.status as DiariaStatus
                    ),
                    pendente = [
                        DiariaStatus.PAGO,
                ...
                return ((avaliada && filtro === 'avaliadas') || (cancelada && filtro === 'cancelada') || (pendente && filtro === 'pendente'))
