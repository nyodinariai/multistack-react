    ...
    detalhesServico(){
        return yup.object().shape({
            ...
            data_atendimento: yup
                ...
                hora_inicio: yup
                    .string()
                    .test('hora_valida', 'Digite uma hora válida',
                    (value) => ValidationService.hora(value)
                    )
                    .test('hora_inicio', 'O serviço não deve começar antes das 06:00',
                    (value) => {
                ...
                hora_termino: yup
                    .string()
                    .test('hora_termino', 'O serviço não deve encerrar após as 22:00',
                    (value) => {
